...
import net.simplifiedlearning.firebaseauth.FirebaseUserModel;
        ...
        usersRef.addListenerForSingleValueEvent(new com.google.firebase.database.ValueEventListener() {
            ...
            public void onDataChange(com.google.firebase.database.DataSnapshot dataSnapshot) {
                ...
                for (com.google.firebase.database.DataSnapshot userSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if (strToken != null && firebaseUserModel.getDeviceId().equals(user.getDeviceId()) && !strToken.equals(firebaseUserModel.getDeviceToken())) {
//                        user.deviceToken = strToken;
                        user.setDeviceToken(strToken);
...
//                                    System.out.println("Refreshed Token Updated");
                                    Toast.makeText(MyFirebaseInstanceIdService.this, "Token refreshed", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
